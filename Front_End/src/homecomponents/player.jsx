...
import Video from "../assets/Zenfuel_Vid.mp4";
...
function player() {
  ...
  const [isMuted, setIsMuted] = useState(true); // Start with unmuted video
  ...
  return (
    ...
    <div className='max-w-screen-2xl container mx-auto'>
      <div className='w-full h-full mt-32 md:mt-0 '>
        <video src={Video} ref={videoRef} muted={isMuted} autoPlay loop></video>
{/*         
        <button className="absolute bottom-10 right-20 hover:bg-white duration-300 text-black p-2 rounded" onClick={toggleMute}>
